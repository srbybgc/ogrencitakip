...
function Home({ classes, groups, dayLessons, currentLesson, activeDay, setActiveDay, onClass, onSchedule, onAdd }) {
  ...
  return <main className="content">
    <div className="welcome"><div><h1 className="home-day-title">{todayLabel}</h1></div><button className="primary" onClick={onAdd}><Plus size={18}/> Yeni</button></div>
