...
export default function SettingsPage() {
  ...
  useEffect(() => {
    let active = true
    loadProfile(user?.uid).then(data => { if (active) setProfile(p => ({ ...p, ...data })) }).catch(() => {})
    return () => { active = false }
  }, [user?.uid])
