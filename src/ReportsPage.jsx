...
import { Download, FileSpreadsheet, Printer, UsersRound, UserRound, CalendarDays, Phone, Check, RotateCcw } from 'lucide-react'
...
const PRESETS={
  full:FIELDS.map(x=>x[0]),
  student:['class','studentNumber','firstName','lastName','birthDate'],
...
export default function ReportsPage({classes=[]}){
  ...
  return <main className="content reports-page">
    ...
    <div className="print-note"><Download size={16}/> Yazdır ekranından “PDF olarak kaydet” seçebilirsin.</div>
  </main>
}
